            ...
            <main id="main">    
                ...
                <section class="page-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <!-- Form -->
                        <form role="form" action="{{ url('product/create') }}" method="post" id="createProductForm" enctype="multipart/form-data">
                            @csrf
                             <div class="card-body">
                                
                                <div class="form-group">
                                    <input type="text" maxlength="60" minlength="2" required class="form-control" id="iduser" placeholder="Id User" name="iduser" value="{{ Auth::user()->id }}" style="display:none">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-mod btn-medium btn-round">Submit</button>
                            </div>
                        </form>
							<!-- End Form -->
                        </div>    

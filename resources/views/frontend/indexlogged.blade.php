        ...
        <div class="page" id="top">
                ...
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                            ...
                            <ul class="clearlist scroll-nav local-scroll">
                                ...
                                <li><a href="{{ url('/cart/'.  Auth::user()->id ) }}">Cart</a></li>
                                <li>
            ...
            <main id="main">    
                    ...
                    <div class="js-height-full container">
                        ...
                        <div class="home-content">
                            <div class="home-text">
                                ...
                                <p class="hs-line-6">
                                    Welcome to our wallapopApp Frontend
                                </p>
                        ...
                        <div class="local-scroll">
                            <a href="#" class="scroll-down"><i class="fa fa-angle-down scroll-down-icon"></i><span class="sr-only">Scroll to the next section</span></a>
                        </div>
                        <!-- End Scroll Down -->
                ...
                <section class="page-section">
                        <div class="mb-20">
                            <a href="{{ url('product/create') }}" class="btn btn-mod btn-circle btn-large" style="margin-left:25%; width:50%">Add new product</a>
                        </div>
                            ...
                            <div class="row multi-columns-row">
                                ...
                                <div class="col-md-4 col-lg-4 mb-60 mb-xs-40">
                                    ...
                                    <div class="post-prev-img">
                                        ...
                                        <a href="{{ url('home/product/' . $product->id) }}"><img src="data:image/png;base64,{{ $product->photo }}"></a>
